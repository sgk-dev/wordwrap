...
WordWrap - исправитель раскладки для Linux (аналог Punto Switcher), под GNOME на Wayland.

Выделите текст, набранный не в той раскладке, и нажмите **Ctrl+F1** - текст
переписывается в правильную раскладку, а системная раскладка переключается следом.
Инструмент ручной: срабатывает только по хоткею, ничего не отслеживает.

Значок в трее включает и выключает конверсию. В настройках - язык интерфейса
(английский по умолчанию, русский переключается), автозапуск при входе, чёрно-белая
иконка, горячие клавиши и чёрный список процессов.
